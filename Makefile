...
small-bench: $(BUILD_DIR) $(NAME).so $(DATA_DIR)
	...
	@python benchmark.py -d $(BENCHMARK_DATA) -p split_50_50 -i 30 -s small -l false -e $(SMALL_BENCH_ELEMENTS)
	@python benchmark.py -d $(BENCHMARK_DATA) -p split_50_50 -i 30 -s small -l true -e $(SMALL_BENCH_ELEMENTS)
	@python benchmark.py -d $(BENCHMARK_DATA) -p produce_and_consume -i 30 -s small -l false -e $(SMALL_BENCH_ELEMENTS)
	@python benchmark.py -d $(BENCHMARK_DATA) -p produce_and_consume -i 30 -s small -l true -e $(SMALL_BENCH_ELEMENTS)
